var Board = function (w, h, n) {
    ...
    //This function fills the squares with numbers according to the neighbour mines
...
function startANewGame() {
    ...
    if (w < 1 || h < 1 || n < 1 || w>99 || h>99 || (n>w*h)) {
        if (board) {
            w = board.width;
            h = board.height;
            n = board.noOfMines;
